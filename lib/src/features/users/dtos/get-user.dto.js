...
let GetUserDto = (() => {
    ...
    return _a = class GetUserDto {
            constructor() {
                this.id = __runInitializers(this, _id_initializers, void 0);
                this.email = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _email_initializers, void 0));
                this.token = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _token_initializers, void 0));
                __runInitializers(this, _token_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_decorators = [IsOptional(), IsMongoId({ message: 'Invalid id' })];
            _email_decorators = [IsOptional(), IsEmail()];
            _token_decorators = [IsOptional(), IsString()];
