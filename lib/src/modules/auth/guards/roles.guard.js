...
let RolesGuard = (() => {
    ...
    var RolesGuard = _classThis = class {
        ...
        canActivate(context) {
            ...
            const rolesArray = this.reflector.getAllAndMerge(ROLES_KEY, [context.getHandler(), context.getClass()]);
            const requiredRoles = rolesArray !== null && rolesArray !== void 0 ? rolesArray : [];
